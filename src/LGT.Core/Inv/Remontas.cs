...
{
  [Key]
  [Column("REM_NR")] public string ID { get; set; } //REM_NR->VARCHAR2(15 BYTE)->No->->8->
  [Column("REM_IR_INV_NR")] public string IrangaID { get; set; } //REM_IR_INV_NR->VARCHAR2(10 BYTE)->No->->1->
