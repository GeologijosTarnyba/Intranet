...
public class FondineKortele
{
  ...
  [Key]
  [Column("FK_NR")]
  public string ID { get; set; } //FK_NR->VARCHAR2(20 BYTE)->No->->1->Fondinės kortelės numeris, pirminis raktas
  /// <summary>
  ...
  public GR_KAD_KNYGOS Knyga { get; set; }
  /// <summary>
  /// Knygų paketo numeris, išorinis raktas į GRĘŽINIŲ KADASTRO KNYGĄ
  /// </summary>
  [Column("FK_GKKPAK_NR")]
  public string KnygaPaketasID { get; set; } //FK_GKKPAK_NR->VARCHAR2(4 BYTE)->No->->3->Knygų paketo numeris, išorinis raktas į GRĘŽINIŲ KADASTRO KNYGĄ
  /// <summary>
