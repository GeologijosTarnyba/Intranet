...
{
  [Key]
  [Column("TYR_SUTR")] public string ID { get; set; }  // Tyrimo trumpinys, naudojamas GEOLIS duomenims tvarkyti
  [Column("TYR_PAV")] public string NameU { get; set; }  // Tyrimo pavadinimas
  public TyrimuRusis? Parent { get; set; } [Column("TYR_TYR_SUTR")] public string? ParentID { get; set; }  // Hierarchinis tyrimo priklausomumas
  ...
  [Column("TYR_PPAV")] public string NameFull { get; set; }  // Pilnas tyrimo pavadinimas, atsižvelgiant į hierarchinį priklausomumą
