...
public class GG_ISTEKLIU_PLOTAI
{
  ...
  [Column("TELK_PAVADINIMAS")] public string TELK_PAVADINIMAS { get; set; } 
  [Column("TELK_ANTRAS_PAV")] public string? TELK_ANTRAS_PAV { get; set; } 
  [Column("TELK_NUMERIS")] public string? TELK_NUMERIS { get; set; } 
  [Column("TELK_IST_TRUMP")] public string TELK_IST_TRUMP { get; set; } 
  [Column("NAUDINGOJI_ISKASENA")] public string? NAUDINGOJI_ISKASENA { get; set; } 
  [Column("GRAFIKA_TRUMP")] public string GRAFIKA_TRUMP { get; set; } 
  [Column("ISTEKLIU_GRUPE")] public string ISTEKLIU_GRUPE { get; set; } 
  [Column("ISTEKLIU_RUSIS")] public string ISTEKLIU_RUSIS { get; set; } 
