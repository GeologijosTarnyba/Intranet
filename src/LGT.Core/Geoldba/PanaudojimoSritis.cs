...
{
  [Key]
  [Column("PNS_KODAS")] public string ID { get; set; } //PNS_KODAS->VARCHAR2(10 BYTE)->No->->1->
  ...
  [Column("PNS_SRITIS")]
  public string Name { get; set; } //PNS_SRITIS->VARCHAR2(100 BYTE)->No->->3->
  /// <summary>
  /// Teisės aktais nustatomas kodas
  /// </summary>
  [Column("PNS_REG_KODAS")]
  public string PNS_REG_KODAS { get; set; } //PNS_REG_KODAS->VARCHAR2(10 BYTE)->No->->4->
  [NotMapped]
  [Column("PNS_INSPIRE")]
