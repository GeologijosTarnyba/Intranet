...
public class TelkinioSluoksnis
{
  ...
  public string TipasID { get; set; } = default!; //AGS_AST_TRUMP->VARCHAR2(10 BYTE)->No->->4->Sutrumpintas sluoksnio tipo pavadinimas.
	[Required] public TelkinioSluoksnioTipas? Tipas { get; set; }
  /// <summary>
