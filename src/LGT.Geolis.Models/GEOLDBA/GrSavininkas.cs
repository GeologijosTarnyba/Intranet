...
public class GrSavininkas
{
  ...
  /// </summary>
  [Column("GSAV_PAVARDE")]
  public string Pavarde { get; set; } = default!; //GSAV_PAVARDE->VARCHAR2(50 BYTE)->No->->2->Gręžinio savininko pavardė
	/// <summary>
	/// Gręžinio savininko vardas
	/// </summary>
	[Column("GSAV_VARDAS")]
  public string Vardas { get; set; } = default!; //GSAV_VARDAS->VARCHAR2(20 BYTE)->No->->3->Gręžinio savininko vardas
	/// <summary>
