...
public class Asmuo
{
  ...
  public ICollection<LGT.Geolis.INV.InventoriausVieta>? InventoriausVietos { get; set; }
  public ICollection<LGT.Geolis.INV.Iranga>? AtsakingasUzIranga { get; set; }
  [Key]
  [Column(name: "ASM_ID")]
  public int ID { get; set; } // NUMBER(7,0) No
  [Column(name: "ASM_PAVARDE")]
  public string Pavarde { get; set; } = default!; // VARCHAR2(25 BYTE) No
	[Column(name: "ASM_VARDAS")]
  public string Vardas { get; set; } = default!; // VARCHAR2(20 BYTE) No
  ...
  #endregion
  public override string ToString() => $"{this.Vardas} {this.Pavarde}[{this.ID}]";
}
