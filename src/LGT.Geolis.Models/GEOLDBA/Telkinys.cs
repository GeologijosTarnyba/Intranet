...
public class Telkinys
{
  ...
  #endregion
  public ICollection<GIS_TELKINIO_SCHEMOS>? TelkinioSchemos { get; set; }
  ...
  [Key]
  [Column(name: "TELK_KODAS")]
  public int ID { get; set; } //TELK_KODAS->NUMBER(5,0)->No->->1->Unikalus, aut. gen. kodas, skirtas ry?iui su grafika.
  [Column(name: "TELK_PAV")]
  public string Name { get; set; } = default!; //TELK_PAV->VARCHAR2(35 BYTE)->No->->3->Pagrindinis telkinio pavadinimas.
	public Telkinys? Parent { get; set; }
  [Column(name: "TELK_TELK_KODAS")] public int? ParentID { get; set; } //TELK_TELK_KODAS->NUMBER(5,0)->Yes->->17->"
  ...
  [Column(name: "TELK_ATV_ID")] public string AdrID { get; set; } = default!; //TELK_ATV_ID->VARCHAR2(20 BYTE)->No->->13->
	[Required] public Adresai.ATV? Adr { get; set; }
