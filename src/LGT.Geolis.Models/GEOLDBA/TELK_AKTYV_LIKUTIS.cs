...
public class TELK_AKTYV_LIKUTIS
{
  ...
  [Column("LIKA_GSKL_KODAS")] public int GavybosSklypasID { get; set; }
  [Required] public IstekliuRusis? IstekliuRusis { get; set; }
  [Column("LIKA_IST_TRUMP")] public string IstekliuRusisID { get; set; } = default!;
  ...
  [Column("LIKA_AU_VARTOTOJAS")] public string LIKA_AU_VARTOTOJAS { get; set; } = default!;
}
