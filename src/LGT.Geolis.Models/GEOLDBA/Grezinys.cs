...
public class Grezinys
{
  ...
  [Required] public GEOG_TASKAI? GeogTaskas { get; set; }
  /// <summary>
  ...
  [Column("GR_PATVIRTINTAS")] public string GR_PATVIRTINTAS { get; set; } = default!; //GR_PATVIRTINTAS->CHAR(1 BYTE)->No->T'->28->
