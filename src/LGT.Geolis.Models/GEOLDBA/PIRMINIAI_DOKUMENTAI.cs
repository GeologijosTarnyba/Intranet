...
public class PirminisDokumentas
{
  ...
  /// </summary>
  [Column("PRDO_NR")]
  public string PRDO_NR { get; set; } = default!; //PRDO_NR->VARCHAR2(20 BYTE)->No->->2->Organizacijos suteiktas dokumento numeris
	/// <summary>
  ...
  public string TipasSutr { get; set; } = default!; //PRDO_PDTIP_SUTR->VARCHAR2(10 BYTE)->No->->4->Aprašamojo dokumento tipo sutrumpinimas, išorinis raktas į PIRMINIU_DOKUMENTU_TIPAI
	[Required] public PirminioDokumentoTipas? Tipas { get; set; }
}
