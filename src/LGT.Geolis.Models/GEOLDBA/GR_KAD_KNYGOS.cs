...
public class GR_KAD_KNYGOS
{
  ...
  public string PaketasID { get; set; } = default!; //GKKN_GKKPAK_NR->VARCHAR2(4 BYTE)->No->->2->Knygų paketo numeris, išorinis raktas į GR_KAD_KNYGU_PAKETAS
	[Required] public GR_KAD_KNYGU_PAKETAI? Paketas { get; set; }
}
