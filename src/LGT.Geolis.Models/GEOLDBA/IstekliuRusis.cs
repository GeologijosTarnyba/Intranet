...
public class IstekliuRusis
{
  ...
  public ICollection<GIS_TELKINIU_SCHEMU_TIPAI>? GIS_TELKINIU_SCHEMU_TIPAI { get; set; }

  [Key][Column(name: "IR_TRUMP")]
  public string ID { get; set; } = default!; //IR_TRUMP->VARCHAR2(10 BYTE)->No->->1->
	[Column(name: "IR_PAV")]
  public string Name { get; set; } = default!; //IR_PAV->VARCHAR2(50 BYTE)->No->->2->
	[Column(name: "IR_PAV_EN")]
  public string Name_EN { get; set; } = default!; //IR_PAV_EN->VARCHAR2(50 BYTE)->No->->7->
	[Column(name: "IR_PAV_KLM")]
  public string Name_Kilmininkas { get; set; } = default!; //IR_PAV_KLM->VARCHAR2(50 BYTE)->No->->4->
  ...
  public string Kodas { get; set; } = default!;//IR_KODAS->VARCHAR2(10 BYTE)->No->->5->
