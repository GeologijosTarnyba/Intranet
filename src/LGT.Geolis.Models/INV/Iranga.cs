...
public class Iranga
{
  ...
  [Key]
  [Column("IR_INV_NR")] public string ID { get; set; } = default!;  //IR_INV_NR->VARCHAR2(10 BYTE)->No->->1->
  [Column("IR_PAJ_DATA")] public DateTime? DatePajamavimo { get; set; } //IR_PAJ_DATA->DATE->Yes->->2->
  [Column("IR_APRASYMAS")] public string Desc { get; set; } = default!;  //IR_APRASYMAS->VARCHAR2(200 BYTE)->No->->3->
  ...
  [Required] public Geoldba.Asmuo? AtsakingasAsmuo { get;set;}
