...
public class LGT_DUOMENU_RINKINIAI
{
  //[NotMapped] // TODO: Map
  //[Column("LGTD_TRUMP")]
  //public string LGTD_TRUMP { get; set; } = default!;  //LGTD_TRUMP->VARCHAR2(10 BYTE)->No->->1->
  //[NotMapped] // TODO: Map
  //[Column("LGTD_PAVADINIMAS")]
  //public string LGTD_PAVADINIMAS { get; set; } = default!;  //LGTD_PAVADINIMAS->VARCHAR2(200 BYTE)->No->->2->
  //[NotMapped] // TODO: Map
  //[Column("LGTD_PASTABA")]
