...
public class LGT_KOMISIJOS
{
  ...
  //public string KOM_PAVADINIMAS { get; set; } = default!;  //KOM_PAVADINIMAS->VARCHAR2(250 BYTE)->No->->2->
  //[NotMapped] // TODO: Map
  //[Column("KOM_TVDOK_DATA")]
  //public DateTime KOM_TVDOK_DATA { get; set; } //KOM_TVDOK_DATA->DATE->No->->3->
  //[NotMapped] // TODO: Map
  //[Column("KOM_TVDOK_NR")]
  //public string KOM_TVDOK_NR { get; set; } = default!;  //KOM_TVDOK_NR->VARCHAR2(20 BYTE)->No->->4->
  //[NotMapped] // TODO: Map
